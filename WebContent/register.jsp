...
<body class="login_website">
	...
	<div class="logo">
		<div class="logo_pic"><a href="index.jsp"><img src="${pageContext.request.contextPath }/img/yay_logo.png"/></a></div>
		<div class="search">
	...
	<div class="content">
		<div class="register_panel">
			<div class="register_panel_title">
				邮箱注册
			<span>已有游啊游的会员？<a href="${pageContext.request.contextPath }/login.jsp">立即登录</a></span>
			</div>
			...
			<div class="register_panel_conr">
				...
				<div class="${pageContext.request.contextPath }/img">
