...
import com.fuandren.utils.WebUtils;
import com.fuandren.web.formbean.RegisterForm;
public class RegisterServlet extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			//此处后期美化
			request.setAttribute("message", "注册成功,浏览器将在3秒后跳转到登陆页面，请您重新登录<meta http-equiv='refresh' content='3;url="+request.getContextPath()+"/login.jsp'>");
